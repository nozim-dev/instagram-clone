...
const VideoItem = ({ videoSrc }) => {
  ...
  return (
    <>
      <video ref={videoRef} onClick={handleVideoClick} onEnded={handleVideoEnd}>
        <source src={videoSrc} type="video/mp4" />
        Your browser does not support the video tag.
      </video>
      <div
        onClick={handleMuteToggle}
        className="Reels_row_col_content_muteControl"
      >
        {isMuted ? (
          <svg
          ...
          <svg
            aria-label="Воспроизводится звуковая дорожка"
            class="x1lliihq x1n2onr6"
            color="rgb(255, 255, 255)"
            fill="rgb(255, 255, 255)"
            height="16"
            ...
            width="16"
          >
            <title>Воспроизводится звуковая дорожка</title>
